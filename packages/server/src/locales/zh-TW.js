...
module.exports = {
  ...
  'Registeration confirm mail send failed, please check your mail configuration if you are administrator.': '註冊確認郵件發送失敗，{%- if isAdmin -%}檢查一下網站的郵件相關配置{% else %}聯繫管理員{%- endif -%}。'
};