...
import type { WalineEmojiInfo, WalineEmojiOptions } from '../typings/index.js';
...
export const getEmojisInfo = (emojis: WalineEmojiOptions | null): Promise<WalineEmojiConfig> =>
  Promise.all(
    ...
    emojiInfos.flat().forEach((emojiInfo) => {
