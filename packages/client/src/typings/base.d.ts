...
/**
 * It is actually the same as `WalineEmojiConfig`, but to avoid circular dependency issue while
 * importing `WalineEmojiConfig`, we redefined a new type here
 */
...
export type WalineEmojiFactory = () =>
  ...
  | Promise<WalineEmojiInfo | WalineEmojiConfigFromFactory>;
