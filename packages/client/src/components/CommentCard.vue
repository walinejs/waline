  ...
  <div :id="comment.objectId" class="wl-item">
    ...
    <div class="wl-card">
      ...
      <div class="wl-meta" aria-hidden="true">
        <span v-if="comment.addr" class="wl-meta-item addr" :data-value="comment.addr" v-text="comment.addr" />
        <span v-if="comment.browser" class="wl-meta-item browser" :data-value="comment.browser" v-text="comment.browser" />
        <span v-if="comment.os" class="wl-meta-item os" :data-value="comment.os" v-text="comment.os" />
      </div>
