...
[Waline_On_Worker](https://github.com/wuyilingwei/Waline_On_Worker) - это реализация сервера на основе Workers от сообщества, восполняющая недостаток того, что Waline не может работать на Cloudflare Workers.
