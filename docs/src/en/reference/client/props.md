...
- Type: `(string | WalineEmojiInfo)[] | 'disabled'`
...
- Type: `WalineImageUploader | 'disabled'`
...
- Type: `WalineHighlighter | 'disabled'`
...
- Type: `WalineTeXRenderer | 'disabled'`
...
- Type: `WalineSearchOptions | 'disabled'`
