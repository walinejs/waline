...
<span class="waline-pageview-count" data-path="/pt-BR/guide/client/count.html" />
times.
```

The current page has been viewed
<span class="waline-pageview-count" data-path="/pt-BR/guide/client/count.html" /> times.
