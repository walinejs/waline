...
| `GRAVATAR_STR`        |          | Gravatar render string，default is `https://seccdn.libravatar.org/avatar/{ {mail\|md5}}`(you need delete the space between the open braces)，base on nunjucks template |
